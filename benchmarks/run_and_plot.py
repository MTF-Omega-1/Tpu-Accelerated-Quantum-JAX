...
def main():
    ...
    ax.set_yscale('log')
    ax.set_title('Quantum Simulator CPU vs CUDA GPU Comparison (Log Scale)', fontsize=14, color='#e6edf3', fontweight='bold', pad=20)
    ...
    ax.annotate(f'⚡ {speedup:.1f}x GPU Speedup!', xy=(18, gpu_time_at_18), xytext=(15, 100), textcoords='offset points', arrowprops=dict(facecolor='#56d364', shrink=0.08, width=1.5, headwidth=6), color='#56d364', fontsize=11, fontweight='bold')

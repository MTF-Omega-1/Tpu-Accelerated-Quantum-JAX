...
FCI_ELECTRONIC_ENERGY = -1.978484
FCI_TOTAL_ENERGY = -1.13728
NUCLEAR_REPULSION = 0.841204
CHEM_ACCURACY_BAND = 0.0016
H2_DATA = [(-0.81054, {}), (0.1712, {0: 'Z'}), (-0.22278, {1: 'Z'}), (-0.22278, {2: 'Z'}), (0.1712, {3: 'Z'}), (0.12091, {0: 'Z', 1: 'Z'}), (0.16862, {0: 'Z', 2: 'Z'}), (0.17434, {1: 'Z', 2: 'Z'}), (0.04532, {0: 'Z', 3: 'Z'}), (0.16862, {1: 'Z', 3: 'Z'}), (0.12091, {2: 'Z', 3: 'Z'}), (0.04532, {0: 'X', 1: 'X', 2: 'Y', 3: 'Y'}), (-0.04532, {0: 'Y', 1: 'X', 2: 'X', 3: 'Y'}), (-0.04532, {0: 'X', 1: 'Y', 2: 'Y', 3: 'X'}), (0.04532, {0: 'Y', 1: 'Y', 2: 'X', 3: 'X'})]
...
def adam_update(p, g, m, v, t, lr=0.01, b1=0.9, b2=0.999, eps=1e-08):
    t = t + 1
    m = b1 * m + (1.0 - b1) * g
    v = b2 * v + (1.0 - b2) * g ** 2
    mh = m / (1.0 - b1 ** t)
...
def run_experiment():
    ...
    for ep in range(1, epochs + 1):
        ...
        if ep == 1 or ep % 20 == 0 or ep == epochs:
            ...
            error = abs(current_energy - FCI_ELECTRONIC_ENERGY) * 1000.0
    ...
    ax.axhspan(FCI_TOTAL_ENERGY - CHEM_ACCURACY_BAND, FCI_TOTAL_ENERGY + CHEM_ACCURACY_BAND, color='#3fb950', alpha=0.12, label='Chemical Accuracy Band')
    ...
    for spine in ax2.spines.values():
        spine.set_edgecolor('#30363d')
    fig.suptitle('VQE for Hydrogen Molecule STO-3G — Differentiable JAX Hamiltonian Solver', color='#e6edf3', fontsize=15, fontweight='bold', y=0.98)
